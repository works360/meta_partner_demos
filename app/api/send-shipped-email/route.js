  ...
  try {
    ...
    if (order.order_status.toLowerCase() !== "shipped") {
      return NextResponse.json(
        { error: "Order not marked as shipped." },
        { status: 400 }
      );
    }
    ...
    const demoPurpose = esc(order.demo_purpose || "");
    const expectedDemos = esc(order.expected_demos || "");
    const returnDate = formatDate(order.return_date);

    const tracking = esc(order.tracking_number || "N/A");
    const trackingLink = esc(order.tracking_number_link || "#");


 // FETCH PRODUCT ITEMS (same as reminder email)
...
const onlineList = buildChipList(onlineApps); 
    ...
    // ----------------------------------------------------
    // HTML TEMPLATE (MATCHES APPROVED / REJECTED / RETURNED)
    // ----------------------------------------------------
          ...
          <table width="650" cellspacing="0" cellpadding="0" border="0"
            ...
            <tr>
              <td style="padding:24px 24px 4px;">
                ...
                <div style="margin-top:33px;padding:15px;border:1px solid #e7edf2;border-radius:10px;text-align:center;font-size:13px;">
                  <strong>Current Status:</strong> <span style="color:#2563eb;font-weight:700;">Shipped</span>
                </div>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:22px 24px;border-bottom:1px solid #eef3f7;font-size:14px;line-height:20px;color:#334b59;">
                ...
                Your order on Meta Partner Demos has been shipped.
                You can find below Tracking information for your order.<br><br>
                <div style="font-size:18px; font-weight:bold; color:#000000; line-height:20px;">
                  PDF Attachment: Partner Demo Setup Guide
                 </div>

               <a href="https://metapartnerdemos.com/pdf/M4W-Demo-set-up-Instructions.pptx.pdf"
                ...
                <table width="100%" style="border:1px solid #e7edf2;border-radius:12px;">
                  ...
                  <tr>
                    ...
                    <td width="50%" align="right" style="padding:12px 16px;">
                      <a href="${trackingLink}" target="_blank" style="color:#2563eb;text-decoration:none;">
                        ${tracking}
                      </a>
                    </td>
                  </tr>
 ...
 <!-- returns -->
            <tr>
              <td style="padding:22px 24px;border-bottom:1px solid #eef3f7;font-size:14px;line-height:20px;color:#334b59;">
                ...
                Submit feedback on the <a href="https://metapartnerdemos.com/returns"
                style="color:#2563eb; text-decoration:underline; font-size:14px;">
               returns
                </a> page once your demo is completed and receive a prepaid label 
                to return the kit back to our warehouse.                
              </td>
            </tr>
                ...
                <table width="100%" style="border:1px solid #e7edf2;border-radius:12px;">
                  ...
                  <tr>
                    <td width="50%" style="padding:12px 16px;">
                      ...
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${salesExec}</div>
                    </td>

                    <td width="50%" style="padding:12px 16px;">
                      <div style="font-size:12px;color:#6b7b86;">Sales Email</div>
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${salesEmail}</div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td style="padding:0 16px 16px;">
                      ...
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${reseller}</div>
                    </td>
                    <td></td>
                  </tr>
                ...
                <table width="100%" style="border:1px solid #e7edf2;border-radius:12px;">
                  ...
                  <tr>
                    <td width="50%" style="padding:12px 16px;">
                      ...
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${demoPurpose}</div>
                    </td>

                    <td width="50%" style="padding:12px 16px;">
                      <div style="font-size:12px;color:#6b7b86;">Expected Demos</div>
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${expectedDemos}</div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td width="50%" style="padding:12px 16px;">
                      ...
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${company}</div>
                    </td>

                    <td width="50%" style="padding:12px 16px;">
                      <div style="font-size:12px;color:#6b7b86;">Opportunity Size</div>
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${opportunity}</div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td width="50%" style="padding:12px 16px;">
                      ...
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${revenue}</div>
                    </td>

                    <td width="50%" style="padding:12px 16px;">
                      <div style="font-size:12px;color:#6b7b86;">Use Case</div>
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${usecase}</div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td width="50%" style="padding:12px 16px;">
                      ...
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${metaReg}</div>
                    </td>

                    <td width="50%" style="padding:12px 16px;">
                      <div style="font-size:12px;color:#6b7b86;">Deal ID</div>
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${dealId}</div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colspan="2" style="padding:12px 16px;">
                      ...
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${returnDate}</div>
                    </td>
                  </tr>
                ...
                <table width="100%" style="border:1px solid #e7edf2;border-radius:12px;">
                  ...
                  <tr>
                    <td width="50%" style="padding:12px 16px;">
                      ...
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${shipName}</div>
                    </td>

                    <td width="50%" style="padding:12px 16px;">
                      <div style="font-size:12px;color:#6b7b86;">Email</div>
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${shipEmail}</div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colspan="2" style="padding:0 16px 16px;">
                      ...
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${shipAddress}</div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colspan="2" style="padding:0 16px 16px;">
                      ...
                      <div style="margin-top:6px;padding:10px;border:1px solid #e7edf2;border-radius:8px;">${shipNotes}</div>
                    </td>
                  </tr>
  ...
  auth: {
    ...
    await transporter.sendMail({
     ...
     // to: order.contact_email || "ammar@works360.com",
      subject: `Order Shipped — #${orderId} | Meta Partner Demos`,
      html,
      attachments: [
        {
          filename: "logo.png",
